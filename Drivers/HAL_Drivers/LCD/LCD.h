...
#define _LCD_ENTRY_MODE					_LCD_INC_CURSOR_SHIFT_OFF
...
#define _LCD_CURSOR_OFF					_LCD_CURSOR_DISPLAY_OFF
#define _LCD_CURSOR_ON					0x09					//Cursor will ON
#define _LCD_UNDERLINE_CURSOR_OFF		_LCD_CURSOR_DISPLAY_OFF
#define _LCD_UNDERLINE_CURSOR_ON		0x0A					//UnderLined Cursor will on
...
#define _LCD_1LINE						_LCD_4BIT_1LINE_70x20	//One line
